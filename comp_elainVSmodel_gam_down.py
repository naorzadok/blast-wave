...
W16_l = np.array([2.3816231972126385, 4.771285538837363, 7.717463702082775, 11.405549443960144, 15.872637375971363, 21.090279130545536, 26.809505272255286, 32.90939087138126])
...
E_res = np.array([2.27387269074933,3.375,3.25438170738284,3.48774919556346])
...
plt.plot(E2_l,Edot,'o',label = 'gamma =1.28')
plt.grid()

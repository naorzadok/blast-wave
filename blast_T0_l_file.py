...
T0_l = np.linspace(280,420,8) #300.0
gamma = 1.4
q_hat = 30.0
Mw = 0.036
P0 = 101325.0
...
for id,ps in enumerate(T0_l):
    ...
    for idx,i in enumerate(c):
        ...
        data1step,Xd_in,eff=zndznd(gamma,q_hat,AA,x[5],1,ps,P0,Mw)

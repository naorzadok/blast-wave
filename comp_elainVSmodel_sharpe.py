...
Ea3    = np.array([10.63399875174423, 9.631248145576679, 8.78955212028069, 8.041020284470452, 7.346298316146313, 6.67221226023447])
E_l  = np.array([3,3,3,3,3,3])
E_res = np.array([80/7])
E2_l  = np.array([3])
x_ind = 1.0
x15_ax  = W15_l/x_ind
...
print('error from od of 1.6', round(np.abs((80/7-9.631248145576679)/(80/7))*100,1),'%')
...
plt.plot(E_l,Ea3,label = 'over drive 1.5-2.0')
plt.plot(E2_l,Edot,'o',label = 'gamma =1.54')
plt.grid()

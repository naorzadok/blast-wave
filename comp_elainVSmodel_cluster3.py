...
plt.gca().add_artist(plt.legend([j1,j2],['Our model','simulation'],title='$\gamma$=1.333; Q=26.333',bbox_to_anchor=(1.3,1.0)))#Lu et al. :,fontsize=18)) ,loc='upper left'))#
################
...
plt.gca().add_artist(plt.legend([l1,l2],['Our model','simulation'],title=' $\gamma$ =1.5 ;  Q=26.333 ',bbox_to_anchor=(1.3,0.75)))#high ,fontsize=18)),loc=0
...
plt.gca().add_artist(plt.legend([t1,t2],['Our model','simulation'],title='  $\gamma$=1.333 ; Q=30.0  ',bbox_to_anchor=(1.3,0.5)))#$Q_{up}$ :,fontsize=18)),loc='upper center'))#
################
...
plt.gca().add_artist(plt.legend([k1,k2],['Our model','simulation'],title='  $\gamma$=1.54  ;  Q=11.5  ',bbox_to_anchor=(1.3,0.25)))#Sharpe et al.-,fontsize=18)),loc='lower right'))#
#####################

...
lu_et = { 'eff2' :[383531.43198113306,23.848958087922757],
          'eff4' :[2111191.705859657,23.848958087922757*2],
          'eff6' :[11836560.246729946,23.848958087922757*3],
          'eff8' :[67699003.97328094,23.848958087922757*4],
          'eff10':[394490218.814581,23.848958087922757*5],
          'eff12':[2342547725.655452,23.848958087922757*6] }
...
for ps in ood:
    ...
    for i in lu_et:
        ...
        print('{} ,cell width={}, cell length={}'.format((i), x[1], x[0]))
        k.append(x[1])
